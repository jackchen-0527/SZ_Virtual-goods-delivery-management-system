    ...
    <el-main>
        ...
        <div>
            <el-button type="primary" @click="dialogFormVisible = true">
                添加产品<el-icon class="el-icon--right">
                    <Upload />
                </el-icon>
            </el-button>
        </div>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="version" label="产品版本" />
            <el-table-column prop="file_path" label="产品路径" />
            <el-table-column prop="decompress_password" label="解压密码" />
...
const getProductList = async () => {
    try {
        const response = await axios.get(`/admin/products/list`, { params: page })
